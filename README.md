...
- If you are using the 'comchap' Post Processing Feature, Move comskipper.dll from www.github.com/BillOatmanWork/Emby.ComSkipper/releases zip file into /EmbyConfig/plugins Directory and reboot your Emby server. (I used a Host Path in TrueNAS when configuring Emby here, so I could drop easily from a SMB share) After reboot, navigate to Manage Server -> Advanced -> Plugins -> Com Skipper and change the settings as needed.
